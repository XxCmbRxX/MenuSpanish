...
const char *get_level_name_ascii(s16 courseNum, s16 levelNum, s16 areaIndex, s16 charCase) {
    ...
    // Castle level
        ...
        switch (levelNum) {
            case LEVEL_CASTLE: {
                switch (areaIndex) {
                    case 1: snprintf(output, 256, "Planta Principal"); break;
                    case 2: snprintf(output, 256, "Planta Superior"); break;
                    case 3: snprintf(output, 256, "Sotano"); break;
                    default: snprintf(output, 256, "Purgatorio"); break;
                }
            } break;
            case LEVEL_CASTLE_GROUNDS: snprintf(output, 256, "Patio Principal"); break;
            case LEVEL_CASTLE_COURTYARD: snprintf(output, 256, "Patio Atras"); break;
            default: snprintf(output, 256, "Castillo Peach");
        }
    }
